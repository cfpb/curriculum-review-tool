...
import EfficacyCriterionRow from './EfficacyCriterionRow';

export default class EfficacyCriterion extends React.Component {
    ...
    return (
      <React.Fragment>
        <div className='block block__flush-top' id={this.props.criterion.divId}>
          ...
          <p><b>Consider all the strong studies together as you answer the remaining questions. Don’t include studies that were not rated strong in Criteria 1.</b></p>
          <ol className='m-list__unstyled'>
            {
              this.props.criterion.rows.map(
                ( rowData, i ) => <EfficacyCriterionRow key={i} {...this.props} row={rowData} /> )
            }
          </ol>
