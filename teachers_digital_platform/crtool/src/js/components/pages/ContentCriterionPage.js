...
export default class ContentCriterionPage extends React.Component {
    ...
    contentClearLocalstorage() {
        this.props.clearLocalstorage();
    }

    checkDistinctiveIsComplete() {
        if (this.props.criterionNotes['content-crt-notes-1'] !== undefined & 
            this.props.criterionNotes['content-crt-notes-2'] !== undefined &
            this.props.criterionAnswers['content-crt-quesion-1.1'] !== undefined &
            this.props.criterionAnswers['content-crt-quesion-1.2'] !== undefined &
            this.props.criterionAnswers['content-crt-quesion-1.3'] !== undefined &
            this.props.criterionAnswers['content-crt-quesion-1.4'] !== undefined &
            this.props.criterionAnswers['content-crt-quesion-2.1'] !== undefined &
            this.props.criterionAnswers['content-crt-quesion-2.2'] !== undefined) {
        ...
        return (
            ...
            <div className="block
                ...
                <div className="m-btn-group
                    ...
                    <button className="a-btn
                                    a-btn__link" onClick={(e) => {this.contentClearLocalstorage()}} >
