            ...
            <div className="block block__flush-top">
                ...
                <div className="m-form-field m-form-field__textarea">
                    ...
                    <textarea className="a-text-input
                                ...
                                id="crt-notes-1"
                                rows="6"
                                value={this.props.criterionNotes['content-elementary-crt-notes-1']} 
                                onChange={e=>this.changeCriterionNotes('content-elementary-crt-notes-1', e.target.value)} >
                    </textarea>
                </div>
            </div>
            <div className="block block__flush-top">
                                ...
                                <div className="o-survey_answer">
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_5c" type="radio" name="crt-question-5" value="0" 
                                            checked={this.props.criterionAnswers["content-elementary-crt-quesion-1.5"] === 'na'}
                                            onChange={() => {this.changeCriterionAnswer('content-elementary-crt-quesion-1.5', 'na')}} />
                ...
                <div className="m-form-field m-form-field__textarea">
                    ...
                    <textarea className="a-text-input
                                ...
                                id="crt-notes-2"
                                rows="6"
                                value={this.props.criterionNotes['content-elementary-crt-notes-2']} 
                                onChange={e=>this.changeCriterionNotes('content-elementary-crt-notes-2', e.target.value)} >
                    </textarea>
                </div>
            </div>
            <div className="block block__flush-top">
