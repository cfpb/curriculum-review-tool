            ...
            <React.Fragment>
                ...
                <div className="block block__flush-top" id="criterion_1">
                    <h2>
                        ...
                        {this.props.criterionCompletionStatuses["content-high-crt-question-1"] === C.ICON_CHECK_ROUND && <span className="u-fc-gray"> (complete)</span>}
                    </h2>
                ...
                <div className="block block__flush-top" id="criterion_2">
                    <h2>
                        ...
                        {this.props.criterionCompletionStatuses["content-high-crt-question-2"] === C.ICON_CHECK_ROUND && <span className="u-fc-gray"> (complete)</span>}
                    </h2>
                    <p className="lead-paragraph u-mb45 u-mt15">
                ...
                <div className="block block__flush-top" id="criterion_3">
                    <h2>
                        ...
                        {this.props.criterionCompletionStatuses["content-high-crt-question-3"] === C.ICON_CHECK_ROUND && <span className="u-fc-gray"> (complete)</span>}
                    </h2>
                    <p className="lead-paragraph u-mb45 u-mt15">
                ...
                <div className="block block__flush-top" id="criterion_4">
                    <h2>
                        ...
                        {this.props.criterionCompletionStatuses["content-high-crt-question-4"] === C.ICON_CHECK_ROUND && <span className="u-fc-gray"> (complete)</span>}
                    </h2>
                    <p className="lead-paragraph u-mb45 u-mt15">
                ...
                <div className="block block__flush-top" id="criterion_5">
                    <h2>
                        ...
                        {this.props.criterionCompletionStatuses["content-high-crt-question-5"] === C.ICON_CHECK_ROUND && <span className="u-fc-gray"> (complete)</span>}
                    </h2>
                    <p className="lead-paragraph u-mb45 u-mt15">
                ...
                <div className="block block__flush-top" id="criterion_6">
                    <h2>
                        ...
                        {this.props.criterionCompletionStatuses["content-high-crt-question-6"] === C.ICON_CHECK_ROUND && <span className="u-fc-gray"> (complete)</span>}
                    </h2>
                    <p className="lead-paragraph u-mb45 u-mt15">
