...
export default class ContentElementarySummaryPage extends React.Component {
    ...
    criterionOveralScoreClassName(level, type) {
        ...
        if (this.props.criterionScores["content-elementary-crt-1"].doesnotmeet ||
            ...
            this.props.criterionScores["content-elementary-crt-3"].doesnotmeet ||
            this.props.criterionScores["content-elementary-crt-4"].doesnotmeet ||
            this.props.criterionScores["content-elementary-crt-5"].doesnotmeet ||
            this.props.criterionScores["content-elementary-crt-6"].doesnotmeet ) {

            isLimited = true;
        }

        let isModerate = false;
        if (this.props.criterionScores["content-elementary-crt-1"].meets &&
            this.props.criterionScores["content-elementary-crt-2"].meets &&
            this.props.criterionScores["content-elementary-crt-3"].meets &&
            this.props.criterionScores["content-elementary-crt-4"].meets &&
            this.props.criterionScores["content-elementary-crt-5"].meets &&
            this.props.criterionScores["content-elementary-crt-6"].meets ) {
            ...
            <React.Fragment>
                ...
                <div className="m-curriculum-status">
                    ...
                    <div className="m-curriculum-status_components">
                        ...
                        <ul className="m-component-list">
                            <li><b>{this.props.criterionScores["content-elementary-crt-1"].essential_total_yes}</b> Yes</li>
                            <li><b>{this.props.criterionScores["content-elementary-crt-1"].essential_total_no}</b> No</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="m-curriculum-status">
                    ...
                    <div className="m-curriculum-status_components">
                        <p><b>Your answers for these components:</b></p>
                        <ul className="m-component-list">
                            <li><b>{this.props.criterionScores["content-elementary-crt-2"].essential_total_yes}</b> Yes</li>
                            <li><b>{this.props.criterionScores["content-elementary-crt-2"].essential_total_no}</b> No</li>
                        </ul>
                    </div>
                </div>
                <div className="m-form-field m-form-field__textarea">
                ...
                <div className="m-curriculum-status">
                    ...
                    <div className="m-curriculum-status_components">
                        <p><b>Your answers for these components:</b></p>
                        <ul className="m-component-list">
                            <li><b>{this.props.criterionScores["content-elementary-crt-3"].essential_total_yes}</b> Yes</li>
                            <li><b>{this.props.criterionScores["content-elementary-crt-3"].essential_total_no}</b> No</li>
                        </ul>
                    </div>
                </div>
                <div className="m-form-field m-form-field__textarea">
                ...
                <div className="m-curriculum-status">
                    ...
                    <div className="m-curriculum-status_components">
                        <p><b>Your answers for these components:</b></p>
                        <ul className="m-component-list">
                            <li><b>{this.props.criterionScores["content-elementary-crt-4"].essential_total_yes}</b> Yes</li>
                            <li><b>{this.props.criterionScores["content-elementary-crt-4"].essential_total_no}</b> No</li>
                        </ul>
                    </div>
                </div>
                <div className="m-form-field m-form-field__textarea">
                ...
                <div className="m-curriculum-status">
                    ...
                    <div className="m-curriculum-status_components">
                        <p><b>Your answers for these components:</b></p>
                        <ul className="m-component-list">
                            <li><b>{this.props.criterionScores["content-elementary-crt-5"].essential_total_yes}</b> Yes</li>
                            <li><b>{this.props.criterionScores["content-elementary-crt-5"].essential_total_no}</b> No</li>
                        </ul>
                    </div>
                </div>
                <div className="m-form-field m-form-field__textarea">
                ...
                <div className="m-curriculum-status">
                    ...
                    <div className="m-curriculum-status_components">
                        <p><b>Your answers for these components:</b></p>
                        <ul className="m-component-list">
                            <li><b>{this.props.criterionScores["content-elementary-crt-6"].essential_total_yes}</b> Yes</li>
                            <li><b>{this.props.criterionScores["content-elementary-crt-6"].essential_total_no}</b> No</li>
                        </ul>
                    </div>
                </div>
                <div className="m-form-field m-form-field__textarea">
                ...
                <div className="o-well u-mb30">
                    ...
                    <div className="m-form-field
                                    ...
                                    u-mb30">
                        <label className="a-label a-label__heading" htmlFor="content-elementary-crt-assets">
                            Assets
                            &nbsp;<small className="a-label_helper">(optional)</small>
                            <small className="a-label_helper a-label_helper__block">
                    ...
                    <div className="m-form-field
                                    m-form-field__textarea
                                    u-mb30">
                        <label className="a-label a-label__heading" htmlFor="content-elementary-crt-gaps">
                            Gaps
                            &nbsp;<small className="a-label_helper">(optional)</small>
                            <small className="a-label_helper a-label_helper__block">
                    ...
                    <div className="m-form-field
                                    m-form-field__textarea">
                        <label className="a-label a-label__heading" htmlFor="content-elementary-crt-overall-notes">
                            Overall notes
                            &nbsp;<small className="a-label_helper">(optional)</small>
                            <small className="a-label_helper a-label_helper__block">
