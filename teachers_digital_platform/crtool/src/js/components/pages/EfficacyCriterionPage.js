...
export default class EfficacyCriterionPage extends React.Component {
    ...
    efficacyClearLocalstorage() {
        this.props.clearLocalstorage();
    }

    checkDistinctiveIsComplete() {
        if (this.props.criterionNotes['efficacy-crt-notes-1'] !== undefined & 
            this.props.criterionNotes['efficacy-crt-notes-2'] !== undefined &
            this.props.criterionAnswers['efficacy-crt-quesion-1.1'] !== undefined &
            this.props.criterionAnswers['efficacy-crt-quesion-1.2'] !== undefined &
            this.props.criterionAnswers['efficacy-crt-quesion-1.3'] !== undefined &
            this.props.criterionAnswers['efficacy-crt-quesion-1.4'] !== undefined &
            this.props.criterionAnswers['efficacy-crt-quesion-2.1'] !== undefined &
            this.props.criterionAnswers['efficacy-crt-quesion-2.2'] !== undefined) {
        ...
        return (
              ...
              <div className="block block__flush-top">
                                ...
                                <div className="o-survey_answer">
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_1a" type="radio" name="crt-question-1" value="1" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.1', 'yes')}} />
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_1b" type="radio" name="crt-question-1" value="0" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.1', 'no')}} />
                                ...
                                <div className="o-survey_answer">
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_2a" type="radio" name="crt-question-2" value="1" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.2', 'yes')}}  />
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_2b" type="radio" name="crt-question-2" value="0" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.2', 'no')}}  />
                                ...
                                <div className="o-survey_answer">
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_3a" type="radio" name="crt-question-3" value="1" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.3', 'yes')}} />
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_3b" type="radio" name="crt-question-3" value="0" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.3', 'no')}} />
                                ...
                                <div className="o-survey_answer">
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_4a" type="radio" name="crt-question-4" value="1" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.4', 'yes')}} />
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_4b" type="radio" name="crt-question-4" value="0" 
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-1.4', 'no')}} />
                ...
                <div className="m-form-field m-form-field__textarea">
                    ...
                    <textarea className="a-text-input
                                ...
                                onChange={e=>this.changeEfficacyNotes('efficacy-crt-notes-1', e.target.value)} />
                </div>
            </div>
            ...
            <div className="block block__flush-top">
                                ...
                                <div className="o-survey_answer">
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_5a" type="radio" name="crt-question-5" value="1"  
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-2.1', 'yes')}} />
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_5b" type="radio" name="crt-question-5" value="0"   
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-2.1', 'no')}} />
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_5c" type="radio" name="crt-question-5" value="0"   
                                            checked={this.props.criterionAnswers["efficacy-crt-quesion-2.1"] === 'na'}
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-2.1', 'na')}} />
                                ...
                                <div className="o-survey_answer">
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_6a" type="radio" name="crt-question-6" value="1"  
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-2.2', 'yes')}}  />
                                    ...
                                    <div className="m-form-field
                                        ...
                                        <input className="a-radio" id="crt-question_6b" type="radio" name="crt-question-6" value="0"  
                                            ...
                                            onChange={() => {this.changeEfficacyRadio('efficacy-crt-quesion-2.2', 'no')}}  />
                ...
                <div className="m-form-field m-form-field__textarea">
                    ...
                    <textarea className="a-text-input
                                ...
                                onChange={e=>this.changeEfficacyNotes('efficacy-crt-notes-2', e.target.value)} />
                </div>
            </div>
            ...
            <div className="block
                ...
                <div className="m-btn-group
                    ...
                    <button className="a-btn
                                    a-btn__link" onClick={(e) => {this.efficacyClearLocalstorage()}} >
