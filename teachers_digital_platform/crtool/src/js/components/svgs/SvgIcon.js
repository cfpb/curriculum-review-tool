...
export default class SvgIcon extends React.Component {
  ...
  render() {
    ...
    } else if (this.props.icon === "SVG_DOCUMENT") {
    ...
    } else if (this.props.icon === "SVG_SETTINGS") {
    ...
    } else if (this.props.icon === "SVG_STAR") {
