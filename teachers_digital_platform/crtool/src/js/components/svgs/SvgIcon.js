...
export default class SvgIcon extends React.Component {
    ...
    render() {
        ...
        if (this.props.icon === C.ICON_CHECK) {
        ...
        } else if (this.props.icon === C.ICON_CREDIT_REPORTT) {       
