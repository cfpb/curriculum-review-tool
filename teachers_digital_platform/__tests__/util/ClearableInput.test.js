...
const ClearableInput = require( BASE_JS_PATH + 'util/ClearableInput' ).ClearableInput;
const simulateEvent = require( BASE_JS_PATH + 'util/simulate-event' ).simulateEvent;
