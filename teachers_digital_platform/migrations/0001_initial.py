...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cfgovpage_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='v1.CFGOVPage')),
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name=b'Updated')),
                ('summary', models.TextField(verbose_name=b'Summary')),
                ('big_idea', wagtail.wagtailcore.fields.RichTextField(verbose_name=b'Big idea')),
                ('essential_questions', wagtail.wagtailcore.fields.RichTextField(verbose_name=b'Essential questions')),
                ('objectives', wagtail.wagtailcore.fields.RichTextField(verbose_name=b'Objectives')),
                ('what_students_will_do', wagtail.wagtailcore.fields.RichTextField(verbose_name=b'What students will do')),
